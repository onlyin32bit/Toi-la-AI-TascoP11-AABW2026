/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: aceb262b320d5f45b25755d4aff86b57)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	ARTIFACTS: R2Bucket;
	DB: D1Database;
	RESTAURANT_SEARCH: VectorizeIndex;
	SOURCE_INGESTION_QUEUE: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "EMBEDDING_MODEL" | "GENERATION_MODEL" | "VISION_MODEL" | "RERANKER_MODEL" | "TRANSCRIPTION_MODEL" | "ENABLE_AI_SEARCH" | "MAX_UPLOAD_BYTES" | "ALLOWED_SOURCE_DOMAINS">> {}
}
